...
const Nav = () => (
  <nav className="bg-transparent fixed top-0 left-0 right-0">
    <div className="bg-transparent flex justify-around w-8/12 m-auto" style={navStyles.navBar}>
      ...
      <Link href="#about"><a className="text-white font-avenir">ABOUT</a></Link>
      <Link href="#projects"><a className="text-white font-avenir">PROJECTS</a></Link>
      <Link href="#connect"><a className="text-white font-avenir">CONNECT</a></Link>
